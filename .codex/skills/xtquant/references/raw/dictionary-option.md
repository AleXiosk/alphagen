...
- Official URL: https://dict.thinktrader.net/dictionary/option.html
- Fetched On: 2026-04-03
- Tags: dictionary, option
- Normalized Reference: references/dictionary/futures-options.md
- Conflict Priority: 3
...
原生python：调用xtdata.download_history_contracts()进行下载

内置python：在界面端数据管理 - 过期合约数据 - 过期合约列表勾选下载，下载后需要重启客户端生效
