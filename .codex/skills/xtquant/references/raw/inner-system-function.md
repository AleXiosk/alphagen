...
- Official URL: https://dict.thinktrader.net/innerApi/system_function.html
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| func | Callable | 回调函数，到达定时器预定时间时触发调用，参数为ContextInfo类型，无需返回值，定义示例如下： def on_timer(C:ContextInfo): pass |
