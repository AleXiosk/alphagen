...
- Official URL: https://dict.thinktrader.net/innerApi/data_function.html
- Fetched On: 2026-04-03
- Tags: inner-python, data-functions
- Normalized Reference: references/inner-python/data-functions.md
- Conflict Priority: 3
...
关于获取行情函数之间的区别与注意事项可在 - 常见问题-行情相关在新窗口打开 查看

除实时行情外，该函数还可用于获取特色数据，如资金流向数据,订单流数据等，获取方式见数据字典在新窗口打开
...
| openInt | float | 若是股票，则openInt含义为股票状态，非股票则是持仓量openInt字段说明在新窗口打开 |
...
此函数已不推荐使用，推荐使用ContextInfo.get_market_data_ex()在新窗口打开
...
推荐使用ContextInfo.get_market_data_ex()在新窗口打开
